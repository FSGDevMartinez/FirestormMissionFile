...
_Btn8 buttonSetAction "[[],""life_fnc_stripPlayer"",life_pInact_curTarget,false] spawn life_fnc_mp; closeDialog 0;";

_Btn9 ctrlSetText localize "STR_pInAct_TestIntox";
_Btn9 buttonSetAction "[life_pInact_curTarget] spawn life_fnc_fingerprint;";

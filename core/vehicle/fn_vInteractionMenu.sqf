...
if(playerSide == west) then {
	...
	if(_curTarget isKindOf "Ship") then {
		...
		if(typeOf (_curTarget) in ["C_Kart_01_Blu_F","C_Kart_01_Red_F","C_Kart_01_Fuel_F","C_Kart_01_Vrana_F"]) then {
			...
			_Btn6 buttonSetAction "_dir = getDir life_vInact_curTarget;life_vInact_curTarget setPosASL [getPosASL life_vInact_curTarget select 0, getPosASL life_vInact_curTarget select 1, (getPosASL life_vInact_curTarget select 2)+0.5];life_vInact_curTarget setvectorup [0,0,1];life_vInact_curTarget setDir _dir; closeDialog 0;";
...
if(playerSide == independent) then {
		...
		if(typeOf (_curTarget) in ["C_Kart_01_Blu_F","C_Kart_01_Red_F","C_Kart_01_Fuel_F","C_Kart_01_Vrana_F"]) then {
			...
			_Btn2 buttonSetAction "_dir = getDir life_vInact_curTarget;life_vInact_curTarget setPosASL [getPosASL life_vInact_curTarget select 0, getPosASL life_vInact_curTarget select 1, (getPosASL life_vInact_curTarget select 2)+0.5];life_vInact_curTarget setvectorup [0,0,1];life_vInact_curTarget setDir _dir; closeDialog 0;";

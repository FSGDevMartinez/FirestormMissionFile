...
if(isNull _vehicle OR !(_vehicle isKindOf "Motorcycle" OR _vehicle isKindOf "Car" OR _vehicle isKindOf "Air" OR _vehicle isKindOf "Ship" OR _vehicle isKindOf "House_F")) exitWith {life_action_inUse = false;}; //Either a null or invalid vehicle type.

if((_vehicle getVariable ["trunk_in_use",false])) exitWith {life_action_inUse = false;hint localize "STR_MISC_VehInvUse"};

...
if((_this select 3) in ["cop","copcid","copsert","coastguard"] && playerSide != west) exitWith {hint localize "STR_Shop_NotaCop"; closeDialog 0;};
if((_this select 3) in ["ems"] && playerSide != independent) exitWith {hint localize "STR_Shop_NotaMED"; closeDialog 0;};
if((_this select 3) in ["ss"] && !license_civ_secretservice) exitWith { hint "You are not in the secret service."; closeDialog 0;};
...
if((_this select 3) in ["slaughter"] && !license_civ_slaughter) exitWith { hint "You are not part of this gang!"; closeDialog 0};
if((_this select 3) in ["Taurus"] && !license_civ_Taurus) exitWith { hint "You are not part of this gang!"; closeDialog 0};
...
if((_this select 3) in ["whitefamily"] && !license_civ_whitefamily) exitWith { hint "You are not part of this gang!"; closeDialog 0};
...
if((_this select 3) in ["tomwalker"] && !license_civ_tomwalker) exitWith { hint "You are not part of this gang!"; closeDialog 0};
if((_this select 3) in ["supernova"] && !license_civ_supernova) exitWith { hint "You are not part of this gang!"; closeDialog 0};
if((_this select 3) in ["firm"] && !license_civ_firm) exitWith { hint "You are not part of this gang!"; closeDialog 0};
if((_this select 3) in ["konvicted"] && !license_civ_konvicted) exitWith { hint "You are not part of this gang!"; closeDialog 0};
if((_this select 3) in ["rpd"] && !license_civ_rpd) exitWith { hint "You are not part of this gang!"; closeDialog 0};
if((_this select 3) in ["strife"] && !license_civ_strife) exitWith { hint "You are not part of this gang!"; closeDialog 0};
...
if((_this select 3) in ["nigo"] && !license_civ_nigo) exitWith { hint "You are not part of this gang!"; closeDialog 0};
if((_this select 3) in ["redwood"] && !license_civ_redwood) exitWith { hint "You are not part of this gang!"; closeDialog 0};
if((_this select 3) in ["hitmen"] && !license_civ_hitmen) exitWith { hint "You are not part of this gang!"; closeDialog 0};
if((_this select 3) in ["goodwin"] && !license_civ_goodwin) exitWith { hint "You are not part of this gang!"; closeDialog 0};
if((_this select 3) in ["sov"] && !license_civ_sov) exitWith { hint "You are not part of this gang!"; closeDialog 0};
if((_this select 3) in ["narco"] && !license_civ_narco) exitWith { hint "You are not part of this gang!"; closeDialog 0};
if((_this select 3) in ["TF01"] && !license_civ_TF01) exitWith { hint "You are not part of this gang!"; closeDialog 0};
if((_this select 3) in ["pepe"] && !license_civ_lospepe) exitWith { hint "You are not part of this gang!"; closeDialog 0};
if((_this select 3) in ["phantom"] && !license_civ_phantom) exitWith { hint "You are not part of this gang!"; closeDialog 0};

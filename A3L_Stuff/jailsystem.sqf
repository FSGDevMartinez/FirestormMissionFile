fnc_arrestmenu = {
	...
	if((_unit getVariable "life_is_arrested")) exitWith {["This person is already arrested!",20,"red"] call A3L_Fnc_Msg; closeDialog 1;};
	if(!(_unit getVariable "restrained")) exitWith {["This person is not restrained!",20,"red"] call A3L_Fnc_Msg; closeDialog 1;}; 
...
fnc_sendtojail = {
	...
	if(live_inv_keycard > 0) then {[false,"keycard",life_inv_keycard] call life_fnc_handleInv;};
